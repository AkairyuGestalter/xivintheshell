...
export class GameState {
	...
	hasThunderhead() { return this.resources.get(ResourceType.Thunderhead).availableAmount() > 0; }
	...
	getSkillAvailabilityStatus(skillName: SkillName) {
		...
		let instantCastAvailable = this.resources.get(ResourceType.Triplecast).available(1)
			...
			|| (skillName===SkillName.Thunder3 && this.resources.get(ResourceType.Thunderhead).available(1))
	...
	toString() {
		...
		s += "TC:\t" + this.resources.get(ResourceType.Thunderhead).availableAmount() + "\n";
